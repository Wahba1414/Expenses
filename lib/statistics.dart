                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: FittedBox(
                                      child: Text(
                                    '${formatMoney(statistics[updatedCategories[index]])} ${(statistics[updatedCategories[index]] != 0) ? ("(~" + (statistics[updatedCategories[index]] / totalExpenses * 100).ceilToDouble().toStringAsFixed(0) + "%)") : ""}',
                                    style: TextStyle(
                                      color: catgeoryColor,
                                      fontSize: 16,
                                    ),
